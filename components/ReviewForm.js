  ...
  return (
    <div style={{ marginTop: 30, padding: 20, backgroundColor: "#1a1a1a", borderRadius: 8, border: "1px solid #333" }}>
      ...
      {user ? (
        ...
        <div style={{ padding: 12, background: "#111", borderRadius: 6 }}>
          <p style={{ color: "#fff" }}>You must be logged in to add a review. <a href="/login" style={{ color: "#22c55e" }}>Login or register</a></p>
        </div>
      )}
    </div>
  );
